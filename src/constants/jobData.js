const jobData = [
  {
    ...
    skills: ["React", "JavaScript", "Redux", "HTML", "CSS", "Git"],
...

  {
    ...
    benefits: ["Medical Insurance", "Stock Options", "Annual Bonus"],
...

  {
    ...
    requirements: ["React", "CSS", "Bootstrap", "Git"],

    benefits: ["WFH", "Medical Insurance", "Flexible Hours"],
...

  {
    ...
    requirements: ["React", "Redux", "TypeScript", "Leadership"],

    benefits: ["Bonus", "Health Insurance", "Paid Leaves"],
